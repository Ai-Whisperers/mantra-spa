      ...
      <main className="bg-background py-20">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="prose prose-sm max-w-none text-foreground-light space-y-4">
            ...
            <p>Recopilamos la información que nos proporcionas voluntariamente al contactarnos a través de formularios o Messaging: nombre, número de teléfono y dirección de correo electrónico.</p>
            ...
            <p>Tenés derecho a acceder, rectificar o eliminar tus datos personales en cualquier momento. Contactanos por Messaging para ejercer estos derechos.</p>
            <h2 className="font-heading text-xl font-bold text-foreground">Contacto</h2>
            <p>Si tenés preguntas sobre esta política, contactanos por Messaging.</p>
